...
#
#   max_msgs  — optional, each client stops after sending this many messages.
#               Omit for unlimited (runs until Ctrl+C).
#
# All traffic is logged silently to server.log — nothing printed here.
...
# If max_msgs set, clients will exit on their own — wait for all of them
wait "${CLIENT_PIDS[@]}"
